...
@section('content')
    ...
    <div class="excuse-container">
        ...
        <h2 style="margin-top: 71px; margin-left: 395px;">List of Student Excuse Slips</h2>
            ...
            <table class="excuse-slip-table">
                ...
                <tbody>
                    @foreach($excuseSlips as $index => $excuseSlip)
                        @if($excuseSlip->status->status_name == 'Pending') <!-- Check if status is Pending -->
                            <tr>
        ...
        @else
            <p>No pending excuse slips found.</p>
        @endif
    </div>
@endsection
